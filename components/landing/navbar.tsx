    ...
    <div className="fixed top-6 inset-x-0 max-w-2xl mx-auto z-50 px-4">
      ...
      >
        ...
        >
          <Icons.logo
            variant="brand"
            className="h-6 w-8 drop-shadow-[0_0_8px_var(--primary)] transition-transform group-hover:scale-110"
          />
        ...
        <div className="flex items-center gap-6">
          ...
          <ThemeToggler className="text-zinc-400 hover:text-white" />
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              size="sm"
              className="rounded-full px-5 h-9 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold shadow-[0_0_20px_rgba(15,118,110,0.3)] transition-all hover:shadow-[0_0_30px_rgba(15,118,110,0.5)] border-none"
            >
              Get Started
            </Button>
          </div>
